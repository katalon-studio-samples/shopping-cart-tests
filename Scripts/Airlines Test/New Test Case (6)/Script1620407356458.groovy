...
WebUI.click(findTestObject('Object Repository/Page_Southwest Airlines - Book a Flight/span_Opens new window. External site which _33a3c4'))
...
WebUI.click(findTestObject('Object Repository/Page_Southwest Airlines  Hotels in San Dieg_3df7c1/a_Car'))
