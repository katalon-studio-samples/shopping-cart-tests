...
WebUI.doubleClick(findTestObject('Object Repository/Page_Southwest Airlines - Book a Flight/a_Low Fare Calendar'))
...
WebUI.click(findTestObject('Object Repository/Page_Southwest Low Fare Calendar  Southwest_5e7418/form_Flight typeRound tripOne-wayMulti-city_d528ea'))
