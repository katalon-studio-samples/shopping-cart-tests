...
WebUI.click(findTestObject('Object Repository/Thien/CartSync/a_chooseProduct', [('index') : 3]))
...
WebUI.click(findTestObject('Object Repository/Thien/CartSync/button_QuaPlus'))
WebUI.delay(2) // Chờ web tính lại tiền
...
// 4. Lấy TỔNG TIỀN (Subtotal) theo XPath mới của bạn
